...
_gsap.default.registerPlugin(_ScrollToPlugin.ScrollToPlugin, _ScrollTrigger.ScrollTrigger);
var App = /*#__PURE__*/_createClass(function App() {
  var _this = this;
  _classCallCheck(this, App);
  _defineProperty(this, "events", function () {
    _this.downButton.addEventListener('click', _this.downButtonHandler);
  });
  _defineProperty(this, "downButtonHandler", function () {
  ...
  _defineProperty(this, "headerAnimation", function () {
    var tl = _gsap.default.timeline();
    tl.from('.intro__image', {
      duration: 2,
      opacity: 0,
      ease: "power1"
    }, "+=0.5");
    tl.from('.intro__overline', {
      duration: 1,
      opacity: 0,
      ease: "power1"
    }, "-=1.5");
    ...
    tl.from('.intro__button', {
      duration: 1,
      opacity: 0,
      ease: "power1"
    }, "-=1");
  });
  _defineProperty(this, "skillsAnimation", function () {
    var tl = _gsap.default.timeline({
      scrollTrigger: {
    ...
    tl.from('.about__headline', {
      opacity: 0,
      y: 20
    });
    var skillsArray = Array.from(document.querySelectorAll('.about__skill'));
    skillsArray.sort(function () {
  ...
  this.events();
  // new gsapAnimation('.scroll-trigger', '.container');
  // new gsapAnimation('.scroll-trigger2', '.box2');
